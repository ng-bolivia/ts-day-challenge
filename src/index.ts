...
// PROD: La clase Person tiene los siguientes atributos: id, firstName, lastName y address. 👈
export class Person {
  constructor(
    protected id: number | string, // QA: El id debería permitir almacenar tanto números como cadenas. 👈
    protected firstName: string,
    protected lastName: string,
    protected address: Address // QA: El address debería ser de usar la interfaz Address 👈
  ) {}
}


// QA: La clase Employee debería heredar de la clase Person. 👈
export class Employee extends Person {
  constructor(
    id: number | string, // QA: El id debería permitir almacenar tanto números como cadenas. 👈
    firstName: string,
    lastName: string,
    address: Address, // QA: El address debería ser de usar la interfaz Address 👈
    private department: string,
    private paymentPerHour: number,
    private workingHours: number,
    private hireDate?: Date // QA: Se debería manejar la fecha como tipo Date y debería ser opcional 👈
  ) {
