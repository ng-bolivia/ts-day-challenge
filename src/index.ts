...
export class Person {
  constructor(
    ...
    protected address: IAddress // TODO: El address debería ser de usar la interfaz Address 👈
  ) {}
}
...
export class Employee extends Person{
  constructor(
    ...
    firstName: string,
    lastName: string,
    address: IAddress, // TODO: El address debería ser de usar la interfaz Address 👈
